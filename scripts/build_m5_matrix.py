...
RAW_6YR = f"{BASE}/gold_seed_full6yr.csv"   # 970k M1 bars 2019-12 → 2026-08
...
def build(out=OUT, incremental=True):
    ...
    # sort by time (col 1 = 'time' is second column? verify) — time is a column
...
def schema_fingerprint():
    ...
    try:
        ...
        hdr = []
    return f"{len(hdr)}|{hdr[:5]}|mfe_mfa_m5"
