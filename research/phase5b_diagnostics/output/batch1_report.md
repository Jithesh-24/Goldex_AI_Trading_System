...
- D4 contradiction rates: {'rate': 0.3584267106535464, 'k': 75618, 'n': 210972, 'ci_lo': 0.356383016470164, 'ci_hi': 0.3604755605736638}, {'rate': 0.0, 'k': 0, 'n': 210972, 'ci_lo': 0.0, 'ci_hi': 1.8208719874588714e-05}
  - NOTE: `barrier` currently aliases `opportunity` in the underlying model (`_oof_for_barrier` is a literal passthrough of `_oof_for_opportunity` in research/phase5_calibration.py), so any opportunity-vs-barrier comparison here is 0/identical by construction and carries no information.
- D5 calibration_vs_meta_label (the actual calibration measurement -- p_barrier_win vs. its real training target): {'intercept': 0.0070546487739272905, 'slope': 1.0085521786133897, 'intercept_se': 0.004475859647042392, 'slope_se': 0.011583298061537925, 'n': 210972}
- D5 directional_touch_agreement (global, symmetric-touch-based -- NOT calibration, a separate diagnostic): {'intercept': 0.07337238978830182, 'slope': 0.013536416717010074, 'intercept_se': 0.004401025634603755, 'slope_se': 0.011363625607768513, 'n': 210972}
- D5 traded_subset: n=106561, brier=0.2572098331425426, calibration.slope=-0.17863923433933807, calibration.intercept=0.1565459595445021
- D6: {'horizon': 15, 'direction': {'long': {'r': 0.018954489622413872, 'n': 126639, 'ci_lo': 0.01344815790916993, 'ci_hi': 0.024459671774151974}, 'short': {'r': 0.008426385951390286, 'n': 126023, 'ci_lo': 0.0029053409325688127, 'ci_hi': 0.013946917276384101}}, 'opportunity': {'long': {'r': 0.007342564159193161, 'n': 104414, 'ci_lo': 0.0012769672556402509, 'ci_hi': 0.01340762079434611}, 'short': {'r': -0.003036386814789118, 'n': 106558, 'ci_lo': -0.009040543452991547, 'ci_hi': 0.0029679887562779604}}, 'barrier': {'long': {'r': 0.007342564159193161, 'n': 104414, 'ci_lo': 0.0012769672556402509, 'ci_hi': 0.01340762079434611}, 'short': {'r': -0.003036386814789118, 'n': 106558, 'ci_lo': -0.009040543452991547, 'ci_hi': 0.0029679887562779604}}}
  - NOTE: `barrier` currently aliases `opportunity` in the underlying model, so any opportunity-vs-barrier per-role comparison above is 0/identical by construction and carries no information.
...
- **calibration** (not decisive): D5 calibration_vs_meta_label slope=1.0085521786133897 (ideal=1.0), traded_subset=computed
...
- D4 contradiction rates: {'rate': 0.0834417199035997, 'k': 17450, 'n': 209128, 'ci_lo': 0.08226407608294892, 'ci_hi': 0.08463466747021836}, {'rate': 0.0, 'k': 0, 'n': 209128, 'ci_lo': 0.0, 'ci_hi': 1.836927351956145e-05}
  - NOTE: `barrier` currently aliases `opportunity` in the underlying model (`_oof_for_barrier` is a literal passthrough of `_oof_for_opportunity` in research/phase5_calibration.py), so any opportunity-vs-barrier comparison here is 0/identical by construction and carries no information.
- D5 calibration_vs_meta_label (the actual calibration measurement -- p_barrier_win vs. its real training target): {'intercept': 0.004003124705318193, 'slope': 0.9705413334214297, 'intercept_se': 0.0044629953597283565, 'slope_se': 0.010748451474187938, 'n': 209128}
- D5 directional_touch_agreement (global, symmetric-touch-based -- NOT calibration, a separate diagnostic): {'intercept': 0.05189212095162599, 'slope': -0.023392819547686763, 'intercept_se': 0.004375909720742281, 'slope_se': 0.010463836790703429, 'n': 209128}
- D5 traded_subset: N/A (zero trades at this horizon)
...
- **calibration** (not decisive): D5 calibration_vs_meta_label slope=0.9705413334214297 (ideal=1.0), traded_subset=N/A (zero trades at this horizon)
...
- D4 contradiction rates: {'rate': 0.01173778058896523, 'k': 2431, 'n': 207109, 'ci_lo': 0.011282894276802239, 'ci_hi': 0.012210779811246195}, {'rate': 0.0, 'k': 0, 'n': 207109, 'ci_lo': 0.0, 'ci_hi': 1.854834287590596e-05}
  - NOTE: `barrier` currently aliases `opportunity` in the underlying model (`_oof_for_barrier` is a literal passthrough of `_oof_for_opportunity` in research/phase5_calibration.py), so any opportunity-vs-barrier comparison here is 0/identical by construction and carries no information.
- D5 calibration_vs_meta_label (the actual calibration measurement -- p_barrier_win vs. its real training target): {'intercept': -0.01748977431109801, 'slope': 0.9035706381089631, 'intercept_se': 0.005740000740259915, 'slope_se': 0.009157569375182991, 'n': 207109}
- D5 directional_touch_agreement (global, symmetric-touch-based -- NOT calibration, a separate diagnostic): {'intercept': 0.02924353086375969, 'slope': -0.015432614663491112, 'intercept_se': 0.005690210820694996, 'slope_se': 0.00840572708169672, 'n': 207109}
- D5 traded_subset: N/A (zero trades at this horizon)
...
- **calibration** (not decisive): D5 calibration_vs_meta_label slope=0.9035706381089631 (ideal=1.0), traded_subset=N/A (zero trades at this horizon)
